		...
		public static void main(String[] args) {
			...
			while (true) {
				...
				case "a": {
					...
					for (int i = 0; i < autoArray.length; i++) {
						for (int j = 0; j < autoArray[i].length; j++) {
							autoArray[i][j] = new Auto(getRandomValueFromRange(100, 260),getRandomValueFromRange(1989, 2023),
				...
				case "b": {
					...
					Auto auto = new Auto(getRandomValueFromRange(100, 260), getRandomValueFromRange(1989, 2023),
							new Helm(getRandomValueFromRange(35, 50),
									helmMaterial[getRandomValueFromRange(0, helmMaterial.length - 1)].toString()),
					...
					System.out.println("autoArray" +Arrays.deepToString(autoArray));
